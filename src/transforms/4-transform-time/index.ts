export namespace TimeUtils {
     ...
     * @param {number} fileTime - the number of 100ns intervals since January 1, 1601 (UTC)
     * @returns {Date}
     **/
     ...
     * @param total - total length of the string
     * @returns string with '0's prefixed 
     */
