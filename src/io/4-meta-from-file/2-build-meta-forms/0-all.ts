...
export function buildManiMetaForms(mani: Mani.Manifest | undefined): Meta.Form[] { //TODO: we should not input as mani, but just forms
 ...
 */
export function buildManiMetaForms2(maniForms: Mani.Form[] | undefined): Meta.Form[] {
